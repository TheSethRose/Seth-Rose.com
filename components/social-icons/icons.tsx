...
export function Twitter(svgProps: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' {...svgProps}>
      <path d='M467.04 57.6h84.72L366.72 269.04 584.4 556.8H414L280.44 382.32 127.8 556.8H42.96l197.88-226.2L32.16 57.6h174.72l120.6 159.48L467.04 57.6zm-29.76 448.56h46.92L181.32 105.6h-50.4l306.36 400.56z' />
    </svg>
  )
}
